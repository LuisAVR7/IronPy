  ...
  return (
    <footer className="bg-gray-900 text-gray-400 mt-16">
      <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-3 gap-8">
        <div>
          <span className="text-xl font-bold text-white">Maq<span className="text-orange-500">Market</span></span>
        ...
        <div>
          ...
          <p className="text-sm">contacto@maqmarket.com.py</p>
        </div>
      </div>
      <div className="border-t border-gray-800 py-4 text-center text-xs">
        © {new Date().getFullYear()} MaqMarket — Todos los derechos reservados — República del Paraguay
      </div>
    </footer>
  )
}